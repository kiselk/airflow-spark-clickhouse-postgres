...
spark_app_name = "Github Archive daily actions - Test 1"
...
dag = DAG(
    dag_id="github-daily-actions",
    description="This DAG runs a GitHub Daily archive analysys.",
...
#     task_id="download_job", dag=dag, python_callable=download_func)

spark_job = SparkSubmitOperator(
    task_id="spark_job",
    # Spark application path created in airflow and spark cluster
    application="/usr/local/spark/app/github-daily-test-spark-module.py",
    name="github-daily-test-spark-module",
